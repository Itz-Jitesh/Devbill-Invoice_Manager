...
const InsightRail = ({ activeProjects = '24', pendingInvoices = '08', growthPercent = '12%' }) => {
  return (
    <aside className="fixed right-0 top-0 h-screen w-80 py-16 px-10 flex flex-col gap-12 bg-white/5 backdrop-blur-[20px] border-l border-white/5 z-40">
      {/* Active Projects */}
      ...
      <div className="mt-auto">
        <div className="rounded-2xl glass-card p-6 overflow-hidden relative group">
          <div
            aria-hidden="true"
          ...
          <div className="relative z-10">
            ...
            <a href="#" className="inline-block mt-4 text-[10px] uppercase tracking-widest font-bold text-primary hover:text-white transition-colors">
              View Analytics →
            </a>
          </div>
        </div>
