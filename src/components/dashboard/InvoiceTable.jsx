          ...
          <tbody className="divide-y divide-white/5">
            {invoices?.map((invoice) => (
              ...
              >
                ...
                <td className="px-8 py-7">
                  <div className="font-mono text-[10px] text-primary/70 font-bold bg-primary/5 px-2.5 py-1 rounded-lg border border-primary/10 inline-block tracking-tighter">
                ...
                <td className="px-8 py-7">
                  <span className={`inline-flex items-center px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase border ${
                    invoice?.status === 'paid' ? 'bg-[#34D399]/5 text-[#34D399] border-[#34D399]/10' :
                    invoice?.status === 'pending' || invoice?.status === 'sent' ? 'bg-primary/5 text-primary border-primary/10' :
                    'bg-slate-500/5 text-slate-400 border-white/5'
                  }`}>
