...
const InvoiceSummaryCard = ({ invoice, setInvoice, subtotal, total, onSave, onPreview }) => {
  ...
  return (
    <aside className="sticky top-12 flex flex-col gap-8">
      ...
      {/* Summary Card */}
      <div className="glass-card p-8 rounded-xl flex flex-col gap-6 shadow-2xl shadow-black/40 border-primary/10">
          ...
          <div className="flex justify-between items-center text-on-surface-variant">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-16 bg-white/5 border border-white/10 rounded-lg px-2 py-1 text-xs text-right text-white focus:outline-none focus:border-primary/50"
              />
          ...
          <div className="flex justify-between items-center text-on-surface-variant">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-24 bg-white/5 border border-white/10 rounded-lg px-2 py-1 text-xs text-right text-white focus:outline-none focus:border-primary/50"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-end mt-2">
          <span className="font-headline font-bold text-white text-lg">Total</span>
          <div className="text-right">
            <span className="block text-[2.5rem] font-headline font-bold text-white leading-none">
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <Button
            variant="outline"
            onClick={onPreview}
            className="w-full py-5 rounded-xl border-white/10 text-on-surface font-label font-bold tracking-widest uppercase text-sm hover:bg-white/5 transition-all"
          >
            Preview
          </Button>
        </div>
