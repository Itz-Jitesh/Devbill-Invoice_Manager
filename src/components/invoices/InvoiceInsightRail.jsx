...
const InvoiceInsightRail = ({
  ...
  return (
    <aside className="fixed right-0 top-0 h-full w-[360px] bg-white/[0.02] backdrop-blur-[40px] border-l border-white/5 p-12 pt-32 space-y-14 z-30 shadow-2xl">
      <div>
        <h3 className="font-headline text-white text-3xl font-bold tracking-tight mb-3">Financial Pulse</h3>
      ...
      <div className="space-y-12">
        ...
        <div className="group relative">
          ...
          <p className="font-headline text-white text-5xl font-bold tracking-tighter transition-all group-hover:scale-105 origin-left">
            ${revenue.toLocaleString('en-US', { minimumFractionDigits: 2 })}
          </p>
          <div className="mt-6 h-1.5 w-full bg-white/5 rounded-full overflow-hidden shadow-inner">
        ...
        <div className="group relative">
          <div className="flex items-center gap-3 text-tertiary mb-4 opacity-80 group-hover:opacity-100 transition-opacity">
            <span className="material-symbols-outlined text-2xl group-hover:animate-pulse">pending_actions</span>
        ...
        {/* Overdue */}
        <div className="group relative">
          <div className="flex items-center gap-3 text-error mb-4 opacity-80 group-hover:opacity-100 transition-opacity">
          ...
          <p className="text-error/70 text-xs mt-4 font-body font-bold tracking-wide">
      ...
      <div className="pt-12 border-t border-white/5">
        <div className="glass-panel p-8 rounded-3xl border border-primary/20 bg-primary/5 hover:bg-primary/10 transition-colors shadow-2xl group relative overflow-hidden">
